...
function MuiTextField(_a) {
    ...
    return (react_1.default.createElement("div", null,
        heading ?
            ...
            : null,
        react_1.default.createElement(material_1.TextField, { id: "description", placeholder: placeholder, minRows: rows, multiline: true, draggable: false, sx: styles, onChange: handleChange, inputProps: { maxLength: 500 }, value: value, disabled: disabled })));
}
